...
<head>
	...
	<title>ayuda.me - encontrá y recomendá soluciones</title>
...
<body>
				...
				<div class="col-md-4">
					<div class="intro-table intro-table-hover">
						...
						<div class="bottom">
							...
							<h4 class="white heading small-pt">Encontral hoy!</h4>
	...
	<section id="faqs" class="section section-padded">
		<div class="container">
			<div class="row text-center title">
				<h2>FAQS</h2>
				<h4 class="light muted">Todo es muy simple...</h4>
			</div>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="owl-twitter owl-carousel">
						<div class="item text-center">
							...
							<h4 class="white light">El trabajo de pintura que hizo <a href="http://twitter.com" class="light-white light">@JuanjoLopez</a> fue excelente!</h4>
							<h4 class="light-white light"> <a href="http://twitter.com" class="light-white light">#pintura</a> <a href="http://twitter.com" class="light-white light">#ayuda.me</a></h4>
						</div>
						<div class="item text-center">
							<i class="icon fa fa-twitter"></i>
							<h4 class="white light">El interior de placard quedó genial!!!.</h4>
							<h4 class="light-white light"><a href="http://twitter.com" class="light-white light">#interiores</a> <a href="http://twitter.com" class="light-white light">#ayuda.me </a><a href="http://twitter.com" class="light-white light">#colaboracion</a></h4>
						</div>
						<div class="item text-center">
							<i class="icon fa fa-twitter"></i>
							<h4 class="white light">Tuve que contratar un ayudante por la cantidad de trabajo que conseguí por recomendaciones.</h4>
							<h4 class="light-white light"><a href="http://twitter.com" class="light-white light">#recomendame</a> <a href="http://twitter.com" class="light-white light">#paisajista </a><a href="http://twitter.com" class="light-white light">#ayuda.me</a></h4>
						</div>
					</div>
				</div>
			</div>
	...
	<footer>
		<div class="container">
			...
			<div class="row bottom-footer text-center-mobile">
				<div class="col-sm-8">
					<p>&copy; 2016 Todos los derechos rreservados. Hecho en <a href="http://www.digitalhouse.com/">Digital House</a> por un grupo de locos.</a></p>
				</div>
